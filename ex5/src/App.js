...
import FormControl from './components/Button/Button';
        ...
        return (
            <>
              ...
              <table className="table table-dark">
                  ...
                  <tbody>                    
                      {this.getFilteredUsers(this.state.userFilter).map((user, index) => {
                          return(
                              <tr key={index}>
                                  <td>{index+1}</td>
                                  <td>{user.username}</td>
                  ...
                  <tfoot>
                    <tr>
                      <th></th>
                      <th colSpan="3">
                        There {this.getFilteredUsers(this.state.userFilter).length === 1 ? 'is' : 'are'} {this.getFilteredUsers(this.state.userFilter).length} {this.getFilteredUsers(this.state.userFilter).length === 1 ? 'result' : 'results'}  
                      </th>
                    </tr>
                  </tfoot>
              </table>
